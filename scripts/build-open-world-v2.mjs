...
const submission = {
  ...
  hooks: [{
    ...
    profile: {
      ...
      evidence: { unit: ["test/FadeLaunchV1.t.sol"], negative: ["test/FadeLaunchV1.t.sol", "test/FadeUniversalRouterTrade.t.sol"], fuzz: ["test/FadeDecayFeeMath.t.sol"], invariant: ["test/FadeAccountingInvariant.t.sol"], fork: [], router: ["test/FadeUniversalRouterTrade.t.sol"], deployment: ["test/FadeUniversalRouterTrade.t.sol"] }
    },
